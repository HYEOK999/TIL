...
class App extends Component {
  constructor(props){
    ...
    this.nav = createRef();
    this.setTodoLists = this.setTodoLists.bind(this);
  }
  ...
  addTodo(e) {
    if (e.key === 'Enter') {
      let todos = { id: this.generateId() , content: e.target.value, completed: false};
      this.setTodoLists([todos])
      e.target.value = '';
    }
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <input className="input-todo" placeholder="What needs to be done?" autoFocus onKeyPress={(e) => this.addTodo(e)} />
